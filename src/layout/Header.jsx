...
function Header() {
  ...
  <div className={cx("wrapper")}>
    <div className={cx("site_header")}>
      <div className={cx("header_logo")}><img src ="src\img\logo2.png" alt="logo" /></div>
      <Input/>
      <div className={cx("header_custom")}>
        <div className={cx("home")}>
         <span className={cx("icon_home")}><IoHome/></span>Hệ thống cửa hàng</div>
        <div className={cx("icon_admin")}><span><IoPersonSharp/></span></div>
        <div className={cx("icon_heart")}><span><FaHeart /></span></div>
        <div className={cx("icon_cart")}><IoCart/></div>
      </div>
    </div>
    ...
    <div className={cx("container")}>
      <div className={cx("sub_container")}>
        <div className={cx("icon_ship")}><span><FaShippingFast/></span></div>
      ...
      <div className={cx("sub_container")}>
        <div className={cx("icon_ship")}><span><MdGroups/></span></div>
        <div className={cx("item_text")}>
      ...
      <div className={cx("sub_container")}>
        <div className={cx("icon_ship")}><span><FaPiggyBank/></span></div>
        <div className={cx("item_text")}>
          <h3>Ưu đãi combo</h3>
